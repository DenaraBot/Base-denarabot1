	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE DENARA BOT`, 
                            orderTitle: `SUBSCRIBE DENARA BOT`,
...
break
	...
	Jangan Lupa Subscribe Denara Bot
`
	but = [
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Denara Bot'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Denara Bot'})
break
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Denara Bot'})
break
case 'cecanmalaysia':
...
sendButton(from, "OVO : 085727492435 (Deva Nanda Arafli)", faketeks, but, mek)
break
case 'donasi':
